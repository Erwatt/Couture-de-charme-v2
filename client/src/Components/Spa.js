            ...
            <div className="modellingFlexRow">
                ...
                <div className="modellingRight">
                    ...
                    <p>Message personnel accompagnant le cadeau :</p>
                        {!validate?<textarea onChange={(e) => setMessage(e.target.value)} rows="5" cols="40" maxLength="240" className="envoiMassage11"/>:<textarea rows="5" cols="40" maxLength="240" className="envoiMassage3" disabled/>}
                    {
