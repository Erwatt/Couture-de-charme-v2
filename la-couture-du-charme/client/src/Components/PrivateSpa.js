...
export default function PrivateSpa(){
    ...
    return (
        <div className="PrivateSpaContainer">
                ...
                <div className="spabox"  data-aos="fade-right">
                ...
                <div className="poufsbox" data-aos="fade-left" data-aos-duration="1000">
                ...
                <div className="saunabox" data-aos="fade-right" data-aos-duration="1000">
